        ...
        {
            {
                "ar", new Dictionary<string, string>
                {
                    ...
                    { "NFC_INVALID_UID_FORMAT", "صيغة معرف البطاقة غير صالحة" },
                    { "NFC_RATE_LIMITED", "يرجى الانتظار 3 ثوانٍ بين المحاولات" },
                    { "NFC_CARD_NOT_FOUND_MSG", "بطاقة غير معروفة" },
                    { "NFC_CARD_NOT_FOUND_SUB", "غير مسجلة" },
                    { "NFC_CARD_NOT_FOUND_ERR", "لم يتم العثور على البطاقة" },
                    { "NFC_CARD_BLOCKED_MSG", "بطاقة معطلة" },
                    { "NFC_CARD_BLOCKED_SUB", "راجع الإدارة" },
                    { "NFC_CARD_BLOCKED_ERR", "تم حظر البطاقة" },
                    { "NFC_CARD_NOT_LINKED_MSG", "بطاقة غير مقترنة" },
                    { "NFC_CARD_NOT_LINKED_SUB", "غير مرتبطة بطالب" },
                    { "NFC_CARD_NOT_LINKED_ERR", "البطاقة غير مرتبطة بأي طالب" },
                    { "NFC_ALREADY_IN_CAMPUS_MSG", "مسجل مسبقا" },
                    { "NFC_ALREADY_IN_CAMPUS_SUB", "حاضر اليوم" },
                    { "NFC_ALREADY_IN_CAMPUS_ERR", "الطالب مسجل دخوله بالفعل اليوم" },
                    { "NFC_WELCOME_MSG", "أهلاً بك" },
                    { "NFC_GOODBYE_MSG", "مع السلامة" },
                    { "NFC_NO_ENTRY_SESSION", "لم يتم تسجيل دخول الطالب من البوابة اليوم" },
                    { "NFC_ROOM_NOT_FOUND_MSG", "غرفة غير معروفة" },
                    { "NFC_ROOM_NOT_FOUND_SUB", "غير موجودة" },
                    { "NFC_ROOM_NOT_FOUND_ERR", "لم يتم العثور على الغرفة" },
                    { "NFC_NO_CLASS_ACTIVE_MSG", "لا يوجد محاضرة" },
                    { "NFC_NO_CLASS_ACTIVE_SUB", "لا توجد محاضرة" },
                    { "NFC_NO_CLASS_ACTIVE_ERR", "لا توجد محاضرة نشطة في هذا الوقت" },
                    { "NFC_ALREADY_IN_ROOM_MSG", "مسجل مسبقا" },
                    { "NFC_ALREADY_IN_ROOM_SUB", "تم تسجيل الحضور" },
                    { "NFC_ALREADY_IN_ROOM_ERR", "تم تسجيل حضور الطالب في هذه القاعة اليوم مسبقاً" },
                    { "NFC_REGISTERED_SUCCESS", "تم تسجيل الحضور" },
                    { "NFC_UID_ALREADY_ENROLLED_MSG", "مسجلة مسبقا" },
                    { "NFC_UID_ALREADY_ENROLLED_SUB", "مسجلة بالفعل" },
                    { "NFC_UID_ALREADY_ENROLLED_ERR", "معرف البطاقة مسجل مسبقاً" },
                    { "NFC_CARD_ENROLLED_MSG", "تم التسجيل" },
                    { "NFC_CARD_ENROLLED_SUB", "تم حفظ البطاقة" },
            ...
            },
            {
                "en", new Dictionary<string, string>
                {
                    ...
                    { "NFC_INVALID_UID_FORMAT", "Missing required field or invalid UID format" },
                    { "NFC_RATE_LIMITED", "Rate limited" },
                    { "NFC_CARD_NOT_FOUND_MSG", "UNKNOWN CARD" },
                    { "NFC_CARD_NOT_FOUND_SUB", "Not enrolled" },
                    { "NFC_CARD_NOT_FOUND_ERR", "Card not found" },
                    { "NFC_CARD_BLOCKED_MSG", "CARD BLOCKED" },
                    { "NFC_CARD_BLOCKED_SUB", "Contact admin" },
                    { "NFC_CARD_BLOCKED_ERR", "Card deactivated" },
                    { "NFC_CARD_NOT_LINKED_MSG", "UNKNOWN CARD" },
                    { "NFC_CARD_NOT_LINKED_SUB", "Not enrolled" },
                    { "NFC_CARD_NOT_LINKED_ERR", "Card not linked to a student" },
                    { "NFC_ALREADY_IN_CAMPUS_MSG", "ALREADY" },
                    { "NFC_ALREADY_IN_CAMPUS_SUB", "Registered" },
                    { "NFC_ALREADY_IN_CAMPUS_ERR", "Student already has an open entry session today" },
                    { "NFC_WELCOME_MSG", "WELCOME" },
                    { "NFC_GOODBYE_MSG", "GOODBYE" },
                    { "NFC_NO_ENTRY_SESSION", "Student has no open campus entry session today" },
                    { "NFC_ROOM_NOT_FOUND_MSG", "UNKNOWN ROOM" },
                    { "NFC_ROOM_NOT_FOUND_SUB", "Not found" },
                    { "NFC_ROOM_NOT_FOUND_ERR", "Room not found" },
                    { "NFC_NO_CLASS_ACTIVE_MSG", "NO CLASS" },
                    { "NFC_NO_CLASS_ACTIVE_SUB", "No active lecture" },
                    { "NFC_NO_CLASS_ACTIVE_ERR", "No scheduled lecture active within the ±15 min window" },
                    { "NFC_ALREADY_IN_ROOM_MSG", "ALREADY" },
                    { "NFC_ALREADY_IN_ROOM_SUB", "Registered" },
                    { "NFC_ALREADY_IN_ROOM_ERR", "Student already registered for this room today" },
                    { "NFC_REGISTERED_SUCCESS", "REGISTERED" },
                    { "NFC_UID_ALREADY_ENROLLED_MSG", "ALREADY" },
                    { "NFC_UID_ALREADY_ENROLLED_SUB", "Registered" },
                    { "NFC_UID_ALREADY_ENROLLED_ERR", "UID already enrolled" },
                    { "NFC_CARD_ENROLLED_MSG", "ENROLLED" },
                    { "NFC_CARD_ENROLLED_SUB", "Card saved" },
